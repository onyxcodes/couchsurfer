(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Surfer = /** @class */ (function () {
        ...
        Surfer.prototype.dbChanges = function (options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.db.changes(options)];
                });
            });
        };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, globalThis.surfer.getClass("UserClass")];
                case 1:
                    UserClass = _a.sent();
    ...
    var CouchSurfer = /** @class */ (function () {
        function CouchSurfer(config) {
            ...
            if (process.env.NODE_ENV === 'development') {
                this.app.use(cors__default["default"]({
            ...
            this.app.use(cookieParser__default["default"]());
            ...
            this.app.use('/api/private', function (req, res, next) {
            ...
            this.app.get('/api/private/reset', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
            ...
            this.app.get('/api/private/clear:conn', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var conn, e_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            this.app.get('/api/private/test', function (req, res) {
                return res.status(200).json({ message: 'Hello from the server! This is a private route' });
            });
            this.app.post('/api/private/create-class/:name', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var name, _a, type, description, newClass, e_3;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
            ...
            this.app.put('/api/private/create-attribute/:name', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var className, _a, name, type, config, classObj, newAttribute, e_4;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.setupAdminUser()];
                        case 2:
                            _a.sent();
        ...
        CouchSurfer.prototype.setupAdminUser = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, setupAdminUser.bind(this)];
                });
            });
        };
