(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('express'), require('dotenv'), require('cors'), require('express-winston'), require('winston'), require('winston-transport'), require('pouchdb-node'), require('crypto'), require('fs'), require('node:fs'), require('node:path'), require('jsonwebtoken'), require('cookie-parser')) :
    typeof define === 'function' && define.amd ? define(['exports', 'express', 'dotenv', 'cors', 'express-winston', 'winston', 'winston-transport', 'pouchdb-node', 'crypto', 'fs', 'node:fs', 'node:path', 'jsonwebtoken', 'cookie-parser'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.couchsurfer = {}, global.express, global.dotenv, global.cors, global.expressWinston, global.winston, global.Transport, global.NodePouchDB, global.crypto, global.fs, global.fs$1, global.path, global.jwt, global.cookieParser));
})(this, (function (exports, express, dotenv, cors, expressWinston, winston, Transport, NodePouchDB, crypto, fs, fs$1, path, jwt, cookieParser) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var envPath$2 = '.env';
    dotenv__default["default"].config({ path: envPath$2 });
    ...
    var generatePswKeys = function () {
        ...
        dotenv__default["default"].config({ override: true });
    };
    ...
    var Class = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            filter = {};
                            this.getPrimaryKeys().reduce(function (accumulator, currentValue) { return accumulator[currentValue] = params[currentValue]; }, filter);
                            return [4 /*yield*/, this.getCards(filter, null, 0, 1)];
                        case 1:
                            cards = _a.sent();
                            if (cards.length > 0) {
        ...
        Class.prototype.getCards = function (selector, fields, skip, limit) {
            return __awaiter(this, void 0, void 0, function () {
                var _selector, docs;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    var countPatches = function () {
        try {
            ...
            return fs__default$1["default"].readdirSync(folderPath).length;
        }
        catch (e) {
    ...
    var Surfer = /** @class */ (function () {
        ...
        Surfer.prototype.checkSystem = function () {
            return __awaiter(this, void 0, void 0, function () {
                var systemDoc, _systemDoc, dbInfo, schemaVersion, schemaVersion;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            schemaVersion = _a.sent();
                            _systemDoc = __assign(__assign({}, systemDoc), { appVersion: Surfer.appVersion, dbInfo: dbInfo, schemaVersion: schemaVersion });
                            _a.label = 6;
                        case 6: 
                        // Update systemDoc
                        return [4 /*yield*/, this.db.put(__assign(__assign({}, _systemDoc), { startupTime: (new Date()).valueOf() }))];
                        case 7:
                            // Update systemDoc
                            _a.sent();
        ...
        Surfer.prototype.getClass = function (className) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, Class.fetch(this, className)];
                        case 1:
                            classObj = _a.sent();
                            return [2 /*return*/, classObj];
                    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            e_6 = _a.sent();
                            logger$1.error("initdb -  something went wrong", e_6);
                            throw new Error("initdb -  something went wrong" + e_6);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            e_7 = _a.sent();
                            if (e_7.name === 'not_found') {
                                logger$1.info("getDocument - not found", e_7);
                                return [2 /*return*/, null];
                            }
                            logger$1.info("getDocument - error", e_7);
                            throw new Error(e_7);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            e_8 = _a.sent();
                            logger$1.info("getDocRevision - error", e_8);
                            throw new Error(e_8);
        ...
        Surfer.prototype.findDocuments = function (selector_1) {
            return __awaiter(this, arguments, void 0, function (selector, fields, skip, limit) {
                var indexFields, result, foundResult, e_9;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 4:
                            e_9 = _a.sent();
                            logger$1.info("findDocument - error", e_9);
                            return [2 /*return*/, { docs: [], error: e_9.toString(), selector: selector, skip: skip, limit: limit }];
        ...
        Surfer.prototype.getClassModel = function (className) {
            return __awaiter(this, void 0, void 0, function () {
                var selector, response, result, e_10;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            selector = {
                        ...
                        case 3:
                            e_10 = _a.sent();
                            logger$1.info("getClassModel - error", e_10);
        ...
        Surfer.prototype.validateObject = function (obj, type, attributeModels) {
            return __awaiter(this, void 0, void 0, function () {
                var isValid, _i, attributeModels_1, model, value, message, message, _a, decryptedString, duplicates, foreignKeyDoc, e_11;
                var _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 13:
                            e_11 = _c.sent();
                            logger$1.info("validateObject - error", e_11);
                            return [2 /*return*/, false];
                        case 14:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 6:
                            ...
                            logger$1.info("validateObjectByType - failed because of error", e_12);
                            return [2 /*return*/, false];
        ...
        Surfer.prototype.createDoc = function (docId, type, classObj, params) {
            return __awaiter(this, void 0, void 0, function () {
                var schema, db, doc, isNewDoc, validationRes, existingDoc, doc_, response, e_13;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 7:
                            ...
                            if (e_13.name === 'conflict') {
                                ...
                                throw new Error("createDoc - Problem while putting doc" + e_13);
                            }
                            return [3 /*break*/, 8];
                        case 8: 
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    UserClass = globalThis.UserClass;
    ...
    var couchsurfer = function () {
        ...
        app.use('/api/private', function (req, res, next) {
            ...
            jwt__default["default"].verify(token, secretKey, function (err, payload) { return __awaiter(void 0, void 0, void 0, function () {
                var sessionId, sessionCards;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, globalThis.UserSessionClass
                                    .getCards({
        ...
        var initInstance = function () { return __awaiter(void 0, void 0, void 0, function () {
            var surfer, UserClass, UserSessionClass;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Surfer.create("db-test", {
                            // defaults to leveldb
                            // adapter: 'memory', 
                            plugins: [
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, surfer.getClass("User")];
                    case 2:
                        UserClass = _a.sent();
                        globalThis.UserClass = UserClass;
                        return [4 /*yield*/, surfer.getClass("UserSession")];
                    case 3:
                        UserSessionClass = _a.sent();
        ...
        app.post('/login', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var _a, username, password, _b, responseCode, body, token, cookieOptions, error_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _c.trys.push([0, 2, , 3]);
        ...
        app.get('/api/private/reset', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, globalThis.surfer.reset()];
                    case 1:
                        _a.sent();
        ...
        app.get('/api/private/clear:conn', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var conn, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        e_2 = _a.sent();
                        logger.error("Error during database clear", e_2);
                        return [2 /*return*/, res.status(500).json({ success: false, error: 'An error occurred' })];
                    case 3: return [2 /*return*/];
                }
            });
        }); });
        app.get('/api/private/test', function (req, res) {
            return res.status(200).json({ message: 'Hello from the server! This is a private route' });
        });
        app.post('/api/private/create-class/:name', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var name, _a, type, description, e_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, Class.create(globalThis.surferInstance, name, type, description)];
                    case 2:
                        _b.sent();
                        logger.info("create-class", "class '".concat(name, "' created successfully."));
                        return [3 /*break*/, 4];
                    case 3:
                        e_3 = _b.sent();
                        logger.error("Error during class '".concat(name, " creation"), e_3);
                        return [2 /*return*/, res.status(500).json({ success: false, error: 'An error occurred' })];
                    case 4: return [2 /*return*/, res.status(200).json({ success: true, message: 'Class created successfully' })];
                }
            });
        }); });
        app.put('/api/private/create-attribute/:name', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var className, _a, name, type, config, classObj, e_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        _b.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, globalThis.surferInstance.getClass(className)];
                    case 2:
                        classObj = _b.sent();
                        return [4 /*yield*/, Attribute.create(classObj, name, type, config)];
                    case 3:
                        _b.sent();
                        logger.info("create-attribute - Attribute '".concat(name, "' added to class '").concat(className, "'"));
                        return [3 /*break*/, 5];
                    case 4:
                        e_4 = _b.sent();
                        logger.error("Error during attribute '".concat(name, "' creation"), e_4);
                        return [3 /*break*/, 5];
                    case 5: return [2 /*return*/];
                }
            });
